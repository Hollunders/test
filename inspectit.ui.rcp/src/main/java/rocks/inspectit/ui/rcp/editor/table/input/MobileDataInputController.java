 ...
 *
 */
public class MobileDataInputController extends AbstractTableInputController {

	/** */
	private static enum Column {
		/** */
		TIMESTAMP("Timestamp", 200, InspectITImages.IMG_TIMESTAMP, false, true, DefaultDataComparatorEnum.TIMESTAMP),
		/** */
		BATTERY("Battery Power", 200, InspectITImages.IMG_BLOCK, false, true, null),
		/** */
		CPU("CPU Usage", 200, InspectITImages.IMG_IMPORT, false, true, null),
		/** */
		MEMORY("Memory Usage", 200, InspectITImages.IMG_CHART_PIE, false, true, null),
		/** */
		STORAGE("Storage Usage", 200, InspectITImages.IMG_EXCEPTION_SENSOR, false, true, null);
